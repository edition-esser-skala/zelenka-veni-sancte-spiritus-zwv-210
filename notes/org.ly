...
Organo = {
  \relative c {
    ...
    \mvTr d'8\fE-\markup \remark "Tutti Registri" d, fis a d d, a' g
    ...
    \tempoQuiPer a2-!-\markup \remark "Registri Soliti" a4. a8 \noBreak
    a4-! a-! d2-!
    fis,4-! r8 d g h a g
    << {
      d'2 d4. d8 %15
    ...
    g a h g d'2
    d,4\fermata r8 d-\markup \remark "Tutti Registri" g, g' fis d
